...
export async function loadProducts(skipInit) {
    try {
        const cols = 'id,name,slug,category,sub_category,price,sale,emoji,featured,price_label,description,size,material,image_url,image_urls,size_variants,colors';
